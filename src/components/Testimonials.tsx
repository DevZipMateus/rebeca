...
const Testimonials = () => {
  return (
    <section id="testimonials" className="section bg-[#21211F]">
      <div className="container-custom">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
            O que nossos clientes <span className="text-rose-400">dizem</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial) => (
            <div 
              key={testimonial.id}
              className="bg-gray-800/50 rounded-2xl p-8 relative hover:bg-gray-800/70 transition-all duration-300 animate-fade-in border border-gray-700 hover:border-rose-400/50"
            ...
            >
              ...
              <div className="border-t border-gray-700 pt-4">
                ...
                <div className="text-rose-400 text-sm">{testimonial.role}</div>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div className="animate-fade-in" style={{ animationDelay: '0.3s' }}>
            ...
            <div className="text-gray-300">Perícias realizadas</div>
          </div>
          <div className="animate-fade-in" style={{ animationDelay: '0.4s' }}>
            <div className="text-3xl font-bold text-rose-400 mb-2">5 anos</div>
